...
namespace DataEncryptAndDecrypt
{
     ...
     */
        ...
        public static void Spinner(Mydata listdata,Spinner spinner,String datatype)
        {
            ...
            try
            {
                if (datatype == "AccountInfo")
                {
                    foreach (Unamepass str in listdata.Unamepass)
                    {
                ...
                {
                    foreach (Cardinfo str in listdata.Cardinfo)
                    {
                        if (!srclist.Contains(str.Source))
                        {
                            srclist.Add(str.Source);
